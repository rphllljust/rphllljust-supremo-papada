...
from .serializers import DeclaracaoSerializer
...
class DeclaracaoViewSet(viewsets.ModelViewSet):
    ...
    queryset = Declaracao.objects.select_related("matricula__aluno__pessoa", "emitido_por__pessoa").order_by("-data_emissao", "-id")
