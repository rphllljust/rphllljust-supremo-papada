...
from .serializers import GuiaTransferenciaSerializer


class GuiaTransferenciaViewSet(viewsets.ModelViewSet):
    permission_classes = [CanAccessModule]
    module_name = "documentos"
    access_surface = "api"
    serializer_class = GuiaTransferenciaSerializer
    pagination_class = StandardResultsSetPagination
    queryset = GuiaTransferencia.objects.select_related("matricula__aluno__pessoa", "emitido_por__pessoa", "transferencia").order_by("-data_emissao", "-id")
