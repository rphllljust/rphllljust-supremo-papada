...
from .profile_views import ServidorMyProfileApiView, ServidorProfileByIdApiView, ServidorProfileByMatriculaApiView
...
urlpatterns = [
    ...
    path("me/perfil/", ServidorMyProfileApiView.as_view(), name="profile-me"),
