...
from apps.api.v1.cursos.views import CursoListApiView


class Command(BaseCommand):
    help = "Test Cursos list API view as admin"
    ...
    def handle(self, *args, **options):
        ...
        request = factory.get(
            "/api/v1/cursos/",
            {"apenas_superiores": "1", "search": "", "page": 1},
        )
        force_authenticate(request, user=user)

        view = CursoListApiView.as_view()
